...
IL_01db:
	{
		...
		*((float*)L_61) = (float)((float)il2cpp_codegen_subtract((float)L_62, (float)L_64));
		...
		L_68 = MixedRealityToolkitVisualProfiler_CalculateFrameColor_m97BBC879738BC265CC1185DF7D9341B70A2CC585(__this, il2cpp_codegen_cast_double_to_int<int32_t>(L_67), /*hidden argument*/NULL);
